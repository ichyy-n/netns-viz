...
contextBridge.exposeInMainWorld('electronAPI', {
  docker: {
    ...
    openShell: (sessionId, shellCmd) => ipcRenderer.invoke('docker-open-shell', sessionId, shellCmd),
    sendCommand: (sessionId, cmd) => ipcRenderer.invoke('docker-send-command', sessionId, cmd),
    closeShell: (sessionId) => ipcRenderer.invoke('docker-close-shell', sessionId),
